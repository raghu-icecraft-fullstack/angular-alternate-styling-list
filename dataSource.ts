...
export let checkboxdata: any = [
    { "text": "Hennessey Venom", "id": "list-01", "htmlAttributes":{class: "list1"} },
    { "text": "Bugatti Chiron", "id": "list-02","htmlAttributes":{class: "list2"} },
    { "text": "Bugatti Veyron Super Sport", "id": "list-03","htmlAttributes":{class: "list1"} },
